...
int main() {
  ...
  try {
    ...
    cout << InetAddress::getLoopbackAddress().getHostName() << " = "
         << InetAddress::getLoopbackAddress().getHostAddress() << endl;
    cout << InetAddress::getLoopbackAddressIPv6().getHostName() << " = "
         << InetAddress::getLoopbackAddressIPv6().getHostAddress() << endl;
    cout << InetAddress::getAnylocalAddress().getHostName() << " = "
         << InetAddress::getAnylocalAddress().getHostAddress() << endl;
    cout << InetAddress::getAnylocalAddressIPv6().getHostName() << " = "
         << InetAddress::getAnylocalAddressIPv6().getHostAddress() << endl;
